  ...
  return (
    <div className="border p-4 rounded-lg shadow-lg">
      ...
      <div className="flex justify-center mt-8 gap-8">
        ...
        <button
                className="bg-blue-500 text-white px-6 py-2 font-kumbh rounded-custom hover:bg-blue-400 focus:outline-none focus:ring-2 focus:ring-green-300 transform hover:scale-105 shadow hover:shadow-lg"
                onClick={() => setSelectedProduct(product)} >Vedi Dettagli</button>
      </div>
    </div>
  );
};
